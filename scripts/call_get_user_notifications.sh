...
# Edge Function URL
LOCAL_URL="http://127.0.0.1:54321/functions/v1/get_user_notifications"

DEPLOYED_URL="https://jschbqhrzkdqcpbidqhj.supabase.co/functions/v1/get_user_notifications"



# JSON 데이터: user_id 설정
DATA='{"p_user_id":"01ba12d0-da6a-45e0-8535-6d2e49a4f96e"}'
