...
console.log("Edge Function 'update_chat_message' is running!");
...
Deno.serve(async (req) => {
  ...
  if (!message_id || !new_content) {
    console.error("❌ Missing required parameters (message_id, new_content).");
    return new Response(
  ...
  try {
    console.log(`🔵 Updating chat message ID: ${message_id}`);
    ...
    console.log("✅ Successfully updated chat message.");
